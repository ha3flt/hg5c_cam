    ...
    public static string Translate(string language, string key)
    {
        ...
        if (!isHu)
        {
            return key switch
            {
                ...
                "StreamSoundSimple" => "Camera sound",
                ...
                "CameraSoundLevel" => "Camera volume",
                "NavigationVolume" => "Camera volume",
                "StepLabel" => "",
                "DefaultLabel" => "Def",
        ...
        return key switch
        {
            ...
            "StreamSoundSimple" => "Kamera hangja",
            ...
            "ForceSoftwareDecoding" => "Szoftveres dekódolás kényszerítése",
            "Refresh" => "Frissítés",
            ...
            "CameraSoundLevel" => "Kamera hangereje",
            "NavigationVolume" => "Kamera hangereje",
            "StepLabel" => "",
            "DefaultLabel" => "Alap",
