...
This project was generated by Claude Sonnet 4.5 based on specifications, and then vibe-coded by OpenAI's GPT‐5.3‐Codex. So far, not a single line has been written by hand.

<img src="hg5c_cam/Assets/hg5c_cam_app_001.jpg" Width=550/>

<img src="hg5c_cam/Assets/hg5c_cam_app_003.jpg" Width=550/>

<img src="hg5c_cam/Assets/hg5c_cam_app_004.jpg" Width=550/>

For a while, we used ODM (ONVIF Device Manager), but it had its limitations—such as the fact that only a single password could be set for all cameras and it lacked a split-screen view—as well as Agent DVR, but that was too complicated for the most of our users.
